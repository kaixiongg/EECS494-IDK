...
public class @ControllerInput : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""AimAssist"",
                    ""type"": ""Button"",
                    ""id"": ""6b7ba315-0e4e-431c-bdcc-60faa297e07f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""765d0d12-db60-492c-9bea-02eed4feba4d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0e1b9784-5de2-4be9-8a65-a578aff919b8"",
                    ""path"": ""<Keyboard>/comma"",
                    ""interactions"": ""Hold"",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Capsule_AimAssist = m_Capsule.FindAction("AimAssist", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Capsule_AimAssist;
    public struct CapsuleActions
    {
        ...
        public InputAction @AimAssist => m_Wrapper.m_Capsule_AimAssist;
        ...
        public void SetCallbacks(ICapsuleActions instance)
        {
            if (m_Wrapper.m_CapsuleActionsCallbackInterface != null)
            {
                ...
                @AimAssist.started -= m_Wrapper.m_CapsuleActionsCallbackInterface.OnAimAssist;
                @AimAssist.performed -= m_Wrapper.m_CapsuleActionsCallbackInterface.OnAimAssist;
                @AimAssist.canceled -= m_Wrapper.m_CapsuleActionsCallbackInterface.OnAimAssist;
            }
